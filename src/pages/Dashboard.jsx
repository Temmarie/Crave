    ...
    <div className="p-6">
      ...
      {user ? (
        <div>
          ...
          <img
            src={
              user.photoURL || "https://placehold.co/600x400/C6D2FF/615FFF.png"
            }
            alt="Profile"
          ...
          <Link
            to="/profile"
            className="mt-2 bg-blue-300 text-white p-2 rounded"
          >
            Edit Profile
          </Link>
          <Link
            to="/add-recipe"
            className="mt-2 bg-green-300 text-white p-2 rounded"
          >
            Add Recipe
          </Link>
          <Link
          ...
          <Link
            to="/ai-recipe"
            className="mt-2 bg-green-700 text-white p-2 rounded"
          >
            Ask Crave
          </Link>
          ...
          <button
            onClick={logout}
            className="mt-4 bg-red-400 text-white p-2 rounded"
          >
            Logout
          </button>
        </div>
